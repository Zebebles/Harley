...
module.exports = class UDefine extends DBF.Command{
    constructor(){
        super({
             name: "udefine", //is pretty much just another trigger, but can be used filter commands.
             triggers: ["urban", "urbandefine", "udefine", "udef"], //any message (excluding msg.client.Prefix) that will trigger this command.
             group: "Misc", //this command will come under this group in the automatic help message.
             ownerOnly : false, //if this command is to be used by the bot creator only.
			 description: "Look up a word in the Urban Dictionary", //this will show in the help message
