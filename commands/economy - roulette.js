...
module.exports = class RouletteCmd extends DBF.Command{
    ...
    run(params = {"msg": msg, "args": args, "user": user}){ //all the code for your command goes in here.
        ...
        if(!args || !args.match(/(red|green|black)/gi) || !args.match(/(\d+|all|half)/gi))
            return msg.channel.send("Usage: `" + msg.guild.prefix +"roulette <red|green|black> amount`" );
        ...
        if(!msg.author.rep || msg.author.rep < amount)
            ...
            return msg.channel.send("You can't bet less than 5 rice on one spin.");
        let draw = false;
        ...
        if(msg.guild.roulette.userIn(msg.author.id))
            return msg.channel.send("You're already in the roulette.");
